...
interface HatCutoutProps {
    style: StyleProp<{}>;
}

const HatCutout = ({style}: HatCutoutProps) => {
    return (
        <View
            style={[
                {
