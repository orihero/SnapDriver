...
interface BubleCutoutProps {
    style: StyleProp<{}>;
}

const BubleCutout = ({style}: BubleCutoutProps) => {
    return (
        <Svg width={63} height={14} viewBox="0 0 63 14" style={style}>
            <Defs>
